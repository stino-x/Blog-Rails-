...
RSpec.describe User, type: :model do
  ...
  describe 'custom methods' do
    it 'returns the most recent posts' do
      ...
      post1 = Post.create(title: 'Post 1', text: 'Content 1', author: user, created_at: 1.day.ago)
      post2 = Post.create(title: 'Post 2', text: 'Content 2', author: user, created_at: 2.days.ago)
      post3 = Post.create(title: 'Post 3', text: 'Content 3', author: user, created_at: 3.days.ago)
